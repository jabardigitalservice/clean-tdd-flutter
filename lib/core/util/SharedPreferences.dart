...
class Preferences {
  static Future<bool> setDataInt(String title, int value) async {
    final prefs = await SharedPreferences.getInstance();

    return prefs.setInt(title, value);
  }

  static Future<bool> setDataString(String title, String value) async {
    final prefs = await SharedPreferences.getInstance();

    return prefs.setString(title, value);
  }

  static Future<bool> setDataBool(String title, bool value) async {
    final prefs = await SharedPreferences.getInstance();
